   ...
   
{
    ...
    public partial class CustomerModel : BaseNopEntityModel
    {
        ...
        //[NopResourceDisplayName("Admin.Customers.Customers.Fields.PhoneNumber")]
        //[AllowHtml]
        ...
        //[NopResourceDisplayName("Admin.Customers.Customers.Fields.ICPassportNo")]
        //[AllowHtml]
        //public string ICPassportNo { get; set; }


        //[NopResourceDisplayName("Admin.Customers.Customers.Fields.Nationality")]
        //[AllowHtml]
        ...
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.ReferralCode")]
        [AllowHtml]
        public int ReferralCode { get; set; }

        public bool StateIDEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.StateID")]
        [AllowHtml]
        public string StateID { get; set; }

        public bool CountryNameEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.CountryNameEnabled")]
        [AllowHtml]
        ...
        //public string ICPassportNoEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.ICPassportNo")]
        [AllowHtml]
        public string ICPassportNo { get; set; }

        public bool BankNameEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BankName")]
        [AllowHtml]
        public string BankName { get; set; }

        public bool BankAccountNameEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BankAccountName")]
        [AllowHtml]
        public string BankAccountName { get; set; }

        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BankAccountNo")]
        [AllowHtml]
        public int BankAccountNo { get; set; }

        //[NopResourceDisplayName("Admin.Customers.Customers.Fields.Name")]
        //[AllowHtml]
        //public string Name { get; set; }

        public bool BeneficiaryICNoEnabled { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BeneficiaryICNo")]
        [AllowHtml]
        public string BeneficiaryICNo { get; set; }

        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BeneficiaryPhoneNumber")]
        [AllowHtml]
        ...
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.BeneficiaryName")]
        [AllowHtml]
        public string BeneficiaryName { get; set; }

        [NopResourceDisplayName("Admin.Customers.Customers.Fields.Relationship")]
        [AllowHtml]
